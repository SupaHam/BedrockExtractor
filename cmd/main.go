...
import (
	"fmt"
	"github.com/SupaHam/BedrockExtractor/BedrockExtractor/gen_structs"
...
func main() {
	config := readConfig()
	defer gen_structs.GeneratorListenerSetup()()
	...
	for {
		...
		serverConn, err := minecraft.Dialer{
			...
			ClientData: data,
			PacketFunc: gen_structs.GeneratorListenerPacketFunc,
